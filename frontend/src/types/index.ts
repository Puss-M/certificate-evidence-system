...
export interface VerificationResult { result: string; verify_result: string; certificate_no: string; student_name?: string; project_name?: string; institution_name?: string; certificate_hash?: string; stored_hash?: string; receipt_id?: string; receipt_exists: boolean; status?: string; message: string; verify_message: string; hash_match: boolean; uploaded_hash?: string; revocation_reason?: string; revoked_at?: string; new_certificate_no?: string }
