...
export interface MerkleProofResult { certificate_no: string; certificate_hash: string; leaf_index: number; leaf_order_rule: string; odd_leaf_rule: string; root_id: string; root_no: string; merkle_root: string; merkle_proof: MerkleProofStep[]; proof: MerkleProofStep[]; proof_valid: boolean; verified: boolean }
